<div class="glass-panel p-8 rounded-2xl w-full">
    <div class="text-center mb-8">
        ...
        <p class="text-sm text-gray-600 mt-2">Pendaftaran Sponsor E-TKI</p>
    </div>

    <form wire:submit.prevent="register" class="space-y-5">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap</label>
            <input type="text" wire:model="name" class="w-full bg-white/50 border border-gray-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition">
        ...
        <div>
            ...
            <input type="password" wire:model="password_confirmation" class="w-full bg-white/50 border border-gray-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition">
        </div>
