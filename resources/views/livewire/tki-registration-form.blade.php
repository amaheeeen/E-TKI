    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" placeholder="Masukkan nama lengkap" wire:model="full_name" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="text" placeholder="Cth: A1234567" wire:model="passport_number" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <select wire:model="gender" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="text" placeholder="Kota kelahiran" wire:model="place_of_birth" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="date" wire:model="date_of_birth" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <select wire:model="marital_status" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div class="md:col-span-2">
                ...
                <textarea wire:model="address" placeholder="Alamat lengkap" rows="2" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 "></textarea>
            ...
            <div>
                ...
                <input type="text" placeholder="Nama Ibu" wire:model="mother_name" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="text" placeholder="Nama Suami/Istri" wire:model="spouse_name" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <select wire:model="education" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="number" wire:model="height" placeholder="Cth: 160" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="number" wire:model="weight" placeholder="Cth: 55" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="text" placeholder="Negara tujuan" wire:model="destination_country" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="text" placeholder="Nama majikan" wire:model="employer_name" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="date" wire:model="medical_date" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="text" placeholder="Status Visa" wire:model="visa_status" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <input type="date" wire:model="departure_date" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div>
                ...
                <select wire:model="sponsor_id" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 ">
            ...
            <div class="md:col-span-2">
                ...
                <textarea wire:model="notes" placeholder="Catatan tambahan" rows="2" class="w-full bg-white/60 border border-mono-300 rounded-xl px-4 py-3.5 text-lg placeholder:text-mono-400 focus:ring-2 focus:ring-mono-500 focus:outline-none transition-all duration-300 backdrop-blur-sm text-mono-900 "></textarea>
